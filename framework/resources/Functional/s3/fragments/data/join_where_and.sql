...
JOIN
  s3.tmp.`big_files/T_DECIMAL_BIG_ZERO_SCALE` decimal_big_zero_scale
ON decimal_big.ID = decimal_big_zero_scale.ID
JOIN
  s3.tmp.`big_files/T_DECIMAL_BIG_ZERO_PREC` decimal_big_zero_prec
ON decimal_big.ID = decimal_big_zero_prec.ID
WHERE
  decimal_big.DECIMAL_2_1 > decimal_big_zero_scale.DECIMAL_2_0
  AND decimal_big_zero_scale.ID > decimal_big.DECIMAL_2_1;
