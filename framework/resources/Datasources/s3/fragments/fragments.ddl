...
DROP TABLE IF EXISTS s3.tmp.`/big_files/T_DECIMAL_BIG`;
CREATE TABLE s3.tmp.`big_files/T_DECIMAL_BIG` (ID, STR_FIELD, DECIMAL_18_8, DECIMAL_2_1, DECIMAL_15_5)
...
FROM s3.tmp.`big_files/decimal_big.tsv`;

DROP TABLE IF EXISTS s3.tmp.`big_files/T_DECIMAL_BIG_ZERO_PREC`;
CREATE TABLE s3.tmp.`/big_files/T_DECIMAL_BIG_ZERO_PREC` (ID, STR_FIELD, DECIMAL_18_18, DECIMAL_2_2, DECIMAL_15_15)
...
FROM s3.tmp.`big_files/decimal_big_zero_prec.tsv`;

DROP TABLE IF EXISTS s3.tmp.`big_files/T_DECIMAL_BIG_ZERO_SCALE`;
CREATE TABLE s3.tmp.`big_files/T_DECIMAL_BIG_ZERO_SCALE` (ID, STR_FIELD, DECIMAL_18_0, DECIMAL_2_0, DECIMAL_15_0)
...
FROM s3.tmp.`big_files/decimal_big_zero_scale.tsv`;
